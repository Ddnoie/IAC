...
import max.ar.demo.common.LabelDisplayUtil;
import max.ar.demo.common.LogUtil;
import max.ar.demo.common.ShaderUtil;
import max.ar.demo.common.WorldShaderUtil;
...
public class LabelDisplay {
     ...
     * This method will be called when {@link CameraRendererManager#onSurfaceCreated}.
     *
     ...
     * This method will be called when {@link CameraRendererManager#onDrawFrame}.
     *
